            ...
            <div class=" main-content-area">
                <div class="wrap-login-item ">
                    <div class="login-form form-item form-stl">
                        <form action="{{url('/signin')}}" method="post" name="frm-login">
                            {{csrf_field()}}
                            ...
                            <fieldset class="wrap-input">
                                ...
                                <input type="text" id="frm-login-uname" name="customer_email"
                                       placeholder="Type your email address">
                            </fieldset>
                            <fieldset class="wrap-input">
                                <label for="frm-login-pass">Password:</label>
                                <input type="password" id="frm-login-pass" name="customer_password" placeholder="************">
                            </fieldset>
