...
<head>
    ...
    <style type="text/css">
        body {
            background: url({{URL::to('backend/img/bg-login.jpg')}}) !important;
        }
    </style>
    ...
    <div class="row-fluid">
        ...
        <div class="row-fluid">
            <div class="login-box">
                ...
                ?>
                <form class="form-horizontal" action="{{url('/panel_dashboard')}}" method="post">
                    {{csrf_field()}}
                        ...
                        <div class="input-prepend" title="Password">
                            ...
                            <input class="input-large span10" name="admin_password" type="password"
